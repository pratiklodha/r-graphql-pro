...
var customCypherField = function customCypherField(_ref) {
  ...
  var fieldIsList = !!fieldType.ofType; // similar: [ x IN apoc.cypher.runFirstColumn("WITH {this} AS this MATCH (this)--(:Genre)--(o:Movie) RETURN o", {this: movie}, true) |x {.title}][1..2])
  ...
  return _objectSpread({
    initial: "".concat(initial).concat(fieldName, ": ").concat(fieldIsList ? '' : 'head(', "[ ").concat(nestedVariable, " IN apoc.cypher.runFirstColumn(\"").concat(customCypher, "\", {").concat((0, _utils.cypherDirectiveArgs)(variableName, headSelection, cypherParams, schemaType, resolveInfo, cypherFieldParamsIndex), "}, true) | ").concat(nestedVariable, " {").concat(subSelection[0], "}]").concat(fieldIsList ? '' : ')').concat(skipLimit, " ").concat(commaIfTail)
  }, tailParams);
};
...
var relationFieldOnNodeType = function relationFieldOnNodeType(_ref2) {
  ...
  var whereClauses = [].concat((0, _toConsumableArray2["default"])(temporalClauses), (0, _toConsumableArray2["default"])(arrayPredicates), (0, _toConsumableArray2["default"])(filterPredicates));
  ...
  return {
    selection: _objectSpread({
      initial: "".concat(initial).concat(fieldName, ": ").concat(!(0, _utils.isArrayType)(fieldType) ? 'head(' : '').concat(orderByParam ? temporalOrdering ? "[sortedElement IN apoc.coll.sortMulti(" : "apoc.coll.sortMulti(" : '', "[(").concat((0, _utils.safeVar)(variableName), ")").concat(relDirection === 'in' || relDirection === 'IN' ? '<' : '', "-[:").concat((0, _utils.safeLabel)([relType]), "]-").concat(relDirection === 'out' || relDirection === 'OUT' ? '>' : '', "(").concat(safeVariableName).concat(!isInlineFragment ? ":".concat((0, _utils.safeLabel)([innerSchemaType.name].concat((0, _toConsumableArray2["default"])((0, _utils.getAdditionalLabels)(resolveInfo.schema.getType(innerSchemaType.name), cypherParams))))) : '').concat(queryParams, ")").concat(whereClauses.length > 0 ? " WHERE ".concat(whereClauses.join(' AND ')) : '', " | ").concat(nestedVariable, " {").concat(isInlineFragment ? "FRAGMENT_TYPE: labels(".concat(nestedVariable, ")[0]").concat(subSelection[0] ? ", ".concat(subSelection[0]) : '') : subSelection[0], "}]").concat(orderByParam ? ", [".concat(buildSortMultiArgs(orderByParam), "])").concat(temporalOrdering ? " | sortedElement { .*,  ".concat(temporalTypeSelections(selections, innerSchemaType), "}]") : "") : '').concat(!(0, _utils.isArrayType)(fieldType) ? ')' : '').concat(skipLimit, " ").concat(commaIfTail)
    }, tailParams),
...
var relationTypeFieldOnNodeType = function relationTypeFieldOnNodeType(_ref3) {
  ...
  var whereClauses = [].concat((0, _toConsumableArray2["default"])(temporalClauses), (0, _toConsumableArray2["default"])(filterPredicates));
  return {
    selection: _objectSpread({
...
var relationTypeMutationPayloadField = function relationTypeMutationPayloadField(_ref5) {
  ...
  return _objectSpread({
    initial: "".concat(initial).concat(fieldName, ": ").concat(safeVariableName, " {").concat(subSelection[0], "}").concat(skipLimit, " ").concat(commaIfTail)
  }, tailParams, {
...
var customQuery = function customQuery(_ref10) {
  ...
  !temporalType && !isScalarType ? "{".concat(subQuery, "} AS ").concat(safeVariableName).concat(orderByClause) : '').concat(outerSkipLimit);
  return [query, params];
}; // Generated API
...
var nodeQuery = function nodeQuery(_ref11) {
  ...
  var predicateClauses = [idWherePredicate].concat((0, _toConsumableArray2["default"])(filterPredicates), (0, _toConsumableArray2["default"])(nullFieldPredicates), (0, _toConsumableArray2["default"])(temporalClauses), (0, _toConsumableArray2["default"])(arrayPredicates)).filter(function (predicate) {
    return !!predicate;
  }).join(' AND ');
  ...
  var query = "MATCH (".concat(safeVariableName, ":").concat(safeLabelName).concat(argString ? " ".concat(argString) : '', ") ").concat(predicate).concat(optimization.earlyOrderBy ? "WITH ".concat(safeVariableName).concat(orderByClause) : '', "RETURN ").concat(safeVariableName, " {").concat(subQuery, "} AS ").concat(safeVariableName).concat(optimization.earlyOrderBy ? '' : orderByClause).concat(outerSkipLimit);
  return [query, params];
...
var translateMutation = function translateMutation(_ref12) {
  ...
  if (mutationTypeCypherDirective) {
    return customMutation(_objectSpread({}, mutationInfo, {
      context: context,
      mutationTypeCypherDirective: mutationTypeCypherDirective,
      variableName: variableName,
      orderByValue: orderByValue,
    ...
    return nodeCreate(_objectSpread({}, mutationInfo, {
      variableName: variableName,
      typeName: typeName,
      additionalLabels: additionalNodeLabels
    }));
  } else if ((0, _utils.isUpdateMutation)(resolveInfo)) {
    return nodeUpdate(_objectSpread({}, mutationInfo, {
      variableName: variableName,
      typeName: typeName,
      additionalLabels: additionalNodeLabels
    }));
  } else if ((0, _utils.isDeleteMutation)(resolveInfo)) {
    return nodeDelete(_objectSpread({}, mutationInfo, {
      variableName: variableName,
      typeName: typeName,
      additionalLabels: additionalNodeLabels
    }));
  } else if ((0, _utils.isAddMutation)(resolveInfo)) {
    return relationshipCreate(_objectSpread({}, mutationInfo, {
      context: context
    }));
  } else if ((0, _utils.isRemoveMutation)(resolveInfo)) {
    return relationshipDelete(_objectSpread({}, mutationInfo, {
      variableName: variableName,
      context: context
    }));
  } else {
...
var nodeUpdate = function nodeUpdate(_ref15) {
  ...
  var predicateClauses = (0, _toConsumableArray2["default"])(temporalClauses).filter(function (predicate) {
    return !!predicate;
  }).join(' AND ');
  var predicate = predicateClauses ? "WHERE ".concat(predicateClauses, " ") : '';
  ...
  var _buildCypherParameter3 = (0, _utils.buildCypherParameters)({
    ...
    paramKey: 'params'
      ...
      _buildCypherParameter4 = (0, _slicedToArray2["default"])(_buildCypherParameter3, 2),
      preparedParams = _buildCypherParameter4[0],
      paramUpdateStatements = _buildCypherParameter4[1];

  var query = "MATCH (".concat(safeVariableName, ":").concat(safeLabelName).concat(predicate !== '' ? ") ".concat(predicate, " ") : "{".concat(primaryKeyArgName, ": $params.").concat(primaryKeyArgName, "})"), "\n  ");
...
var nodeDelete = function nodeDelete(_ref16) {
  ...
  var _splitSelectionParame3 = (0, _utils.splitSelectionParameters)(params, primaryKeyArgName),
      _splitSelectionParame4 = (0, _slicedToArray2["default"])(_splitSelectionParame3, 1),
  ...
  var _buildCypherParameter5 = (0, _utils.buildCypherParameters)({
    ...
    params: params
      ...
      _buildCypherParameter6 = (0, _slicedToArray2["default"])(_buildCypherParameter5, 1),
      preparedParams = _buildCypherParameter6[0];

  var query = "MATCH (".concat(safeVariableName, ":").concat(safeLabelName).concat(temporalClauses.length > 0 ? ") WHERE ".concat(temporalClauses.join(' AND ')) : " {".concat(primaryKeyArgName, ": $").concat(primaryKeyArgName, "})"));
...
var relationshipCreate = function relationshipCreate(_ref17) {
  ...
  params = _objectSpread({}, preparedParams, {}, subParams);
  var query = "\n      MATCH (".concat(fromVariable, ":").concat(fromLabel).concat(fromTemporalClauses && fromTemporalClauses.length > 0 ? // uses either a WHERE clause for managed type primary keys (temporal, etc.)
...
var relationshipDelete = function relationshipDelete(_ref18) {
  ...
  var toTemporalClauses = (0, _utils.temporalPredicateClauses)(params.to, toVariable, toTemporalArgs, 'to'); // TODO cleaner semantics: remove use of _ prefixes in root variableNames and variableName
...
var processFilterArgument = function processFilterArgument(_ref19) {
  var fieldArgs = _ref19.fieldArgs,
      ...
      rootIsRelationType = _ref19$rootIsRelation === void 0 ? false : _ref19$rootIsRelation;
...
var analyzeFilterArguments = function analyzeFilterArguments(_ref20) {
  ...
  return (0, _entries["default"])(filterValue).reduce(function (_ref21, _ref22) {
  ...
  var serializedValues = filterValue.reduce(function (serializedValues, filter) {
    ...
    if (filter['formatted']) serializedValue = filter['formatted'];else {
      serializedValue = (0, _entries["default"])(filter).reduce(function (serialized, _ref29) {
        ...
        if ((0, _isInteger["default"])(value)) value = _neo4jDriver.v1["int"](value);
...
var translateScalarFilter = function translateScalarFilter(_ref35) {
  ...
  return "".concat(nullFieldPredicate).concat(buildOperatorExpression(filterOperationType, propertyPath), " ").concat(parameterPath);
};
...
var buildFilterPredicates = function buildFilterPredicates(_ref46) {
  ...
  return (0, _entries["default"])(filterValue).reduce(function (predicates, _ref47) {
...
var buildTemporalPredicate = function buildTemporalPredicate(_ref50) {
  ...
  var translation = "(".concat(nullFieldPredicate).concat(operatorExpression, " ").concat(temporalFunction, "(").concat(listVariable, "))");
